...
use Core\API2\Resources\Feed\Topic as TopicResource;
use Illuminate\Database\Eloquent\Builder as EloquentBuilder;
use Core\API2\Requests\Feed\TopicIndex as IndexRequest;
use Core\API2\Requests\Feed\EditTopic as EditTopicRequest;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Core\Models\FeedTopicUserLink as FeedTopicUserLinkModel;
use Core\API2\Requests\Feed\CreateTopic as CreateTopicRequest;
...
class Topic extends Controller
{
     ...
     * Create an topic.
     *
     * @param  \Core\API2\Requests\Feed\CreateTopic  $request
     *
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     * Edit an topic.
     *
     * @param  \Core\API2\Requests\Feed\EditTopic  $request
